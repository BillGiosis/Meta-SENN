...
from dataset_classes.fgvcaircraft import FGVCAircraftClass
...
def get_data(dataset, crop = True, img_size=448):
    ...
    if dataset == "CUB2011":
        ...
        train_transform = get_augmentation(0.1, img_size, True, True, True, True, normalize_params["FGVCAircraft"])
        test_transform = get_augmentation(0.1, img_size, False, True, True, True, normalize_params["FGVCAircraft"])
